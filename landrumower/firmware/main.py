...
class PicoMowerDriver:
    ...
    led = Pin("LED", Pin.OUT)
    pinRain = ADC(Pin(28))
    pinDockButton = Pin(26, Pin.IN, Pin.PULL_UP)  # GPIO26 (Pin 31) - Return to dock button
    ...
    pinStartButton = Pin(27, Pin.IN, Pin.PULL_UP)
    ...
    isDocking: bool = False  # Dokkolási állapot
    ...
    def readSensors(self) -> None:
        ...
        # start button
        if self.pinStartButton.value() == 1:
            self.startButton = 1
        else:
            self.startButton = 0
